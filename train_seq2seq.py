...
from networks.seq2seqModel1_2 import Vrnn, Gaussian, Sampling


def run(exp, model_name, model):
    ...
    if model_name is None:
        model_name = os.path.join(exp, 'seq2seqModel_12_STFT')
...
if __name__ == '__main__':
    model_name = os.path.join('exp', 'seq2seqModel1_2_STFT')
    run(exp=None, model_name=model_name, model=None)
